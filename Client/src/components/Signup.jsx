...
const Signup = () => {
    ...
    const showpassword = () => {
      ...
      updatedIconColor[2].type = showPassword? 'password' : 'text';
      ...
      <div className='text-sm flex justify-center items-center h-screen customsm:overflow-hidden'>
        <div className="w-full flex justify-center items-center h-screen xl:w-1/2">
          <div className="border-2 border-customBorderPurple rounded-3xl text-start customsm:border-none" style={{ width: "450px", height: "570px", padding: '10px 70px' }}>
            <h1 className="mt-6 font-semibold text-xl text-center">Register</h1>
            <form action="" onSubmit={registerUser} className="mt-6">
              ...
              <a href=""><button className='mt-6 border border-customBlue p-2 w-customButtonWidth rounded-xl bg-customBlue text-white font-semibold text-base'>Register</button></a>
              ...
              <p className='mt-5 text-gray-400 text-center'>Or Register With:</p>
              <ol className='flex justify-between mt-4'>
                <li className='border border-customBorderPurple p-3 rounded-xl'><FcGoogle className='w-8 h-8 cursor-pointer' /></li>
                <Link className='border border-customBorderPurple p-3 rounded-xl cursor-pointer'><FacebookSvg /></Link>
