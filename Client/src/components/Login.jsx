  ...
  return (
    <div className="text-sm flex justify-center items-center h-screen customsm:overflow-hidden">
      <div className="w-full flex justify-center items-center h-screen xl:w-1/2">
        <div
          className="border-2 border-customBorderPurple rounded-3xl text-start  customsm:border-none"
          style={{ width: "450px", height: "570px", padding: "10px 70px" }}
        >
          <h1 className="mt-14 font-semibold text-xl text-center">
            Get More Access
          </h1>
          <form action="" className="mt-6">
              ...
              <div key={index} className="container">
                <div className="relative mt-6">
                  <input
                    ...
                    value={data[item.id]}
                    className={`input ${
                      data[item.id] ? "border-customInputBorderPurple" : ""
                    }`}
                  ...
                  {item.id === "password" && (
                    <div className="absolute top-5 right-2 customsm:left-72">
                      <span
                        ...
                        className="text-gray-400 cursor-pointer customsm:ml-auto"
                      >
                  ...
                  <div
                    className={`label ${data[item.id] ? "has-content" : ""} ${
                      iconColor[index].iconColor ? "text-customIconColor" : ""
                    }`}
                  >
                    <span className="icon">{item.icon}</span>
                    <span style={{ marginTop: "-2px" }} className="labelText">
                      {item.label}
                    </span>
                  </div>
                </div>
            ...
            <div className="flex justify-end mt-2">
              <div>
                <a
                  href=""
                  className="text-customBlue font-medium underline underline-offset-4"
                >
                  Forgot Password?
                </a>
              </div>
            ...
            <button
              onClick={loginUser}
              className="mt-6 border border-customBlue p-2 w-customButtonWidth rounded-xl bg-customBlue text-white font-semibold text-base"
            >
              Login
            </button>
            ...
            <ol className="flex justify-between mt-4">
              <button
                className="border border-customBorderPurple p-3 rounded-xl"
                onClick={googleAuthenticate}
              >
                <FcGoogle className="w-8 h-8 cursor-pointer" />
              </button>
              <li className="border border-customBorderPurple p-3 rounded-xl cursor-pointer">
                <FacebookSvg />
              </li>
              <li className="border border-customBorderPurple p-3 rounded-xl cursor-pointer">
                <Twitter />
      ...
      <div className="w-1/2 hidden xl:block">
        <img
          src={SignupImage}
          alt=""
          className="h-customSignupHeight mt-10"
